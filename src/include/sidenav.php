<aside class="sidenav img_linear_gradient_bg">
    ...
    <ul>
        ...
        <?php if ($_SESSION['user_level'] == 3): ?>
            ...
            <li><a href="services.php"><span class="icon-"></span> Services</a></li>
        <?php endif; ?>
            <li><a href="orders.php"><span class="icon-home"></span> Orders</a></li>
            <li><a href="billings.php"><span class="icon-building"></span> Billings</a></li>
    </ul>
